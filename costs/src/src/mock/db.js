...
export const projectsData = [
  {
    "id": "1", // Corrigido para string para manter a consistência
  ...
  {
    "id": "2", // Corrigido para string para manter a consistência
    "name": "Campanha de Marketing",
    "budget": "3000",
    "category": { "id": "4", "name": "Planejamento" }, // Categoria corrigida para uma que existe na lista
    "cost": 0,
    "services": []
  },
  {
